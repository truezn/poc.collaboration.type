...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.enterpriseprojectcreatereadupdatedelete.EnterpriseProjectJVA EnterpriseProjectJVA}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class EnterpriseProjectJVAField<FieldT >
    extends EntityField<EnterpriseProjectJVA, FieldT>
    implements EnterpriseProjectJVASelectable
{
     ...
     */
    public EnterpriseProjectJVAField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public EnterpriseProjectJVAField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
