...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.enterpriseprojectcreatereadupdatedelete.EnterpriseProjectElement EnterpriseProjectElement}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class EnterpriseProjectElementField<FieldT >
    extends EntityField<EnterpriseProjectElement, FieldT>
    implements EnterpriseProjectElementSelectable
{
     ...
     */
    public EnterpriseProjectElementField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public EnterpriseProjectElementField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
