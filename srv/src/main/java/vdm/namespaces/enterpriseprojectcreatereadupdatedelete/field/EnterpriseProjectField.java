...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.enterpriseprojectcreatereadupdatedelete.EnterpriseProject EnterpriseProject}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class EnterpriseProjectField<FieldT >
    extends EntityField<EnterpriseProject, FieldT>
    implements EnterpriseProjectSelectable
{
     ...
     */
    public EnterpriseProjectField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public EnterpriseProjectField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
