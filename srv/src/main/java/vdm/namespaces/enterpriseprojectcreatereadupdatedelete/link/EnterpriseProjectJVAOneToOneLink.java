...
/**
 * Template class to represent entity navigation links of {@link vdm.namespaces.enterpriseprojectcreatereadupdatedelete.EnterpriseProjectJVA EnterpriseProjectJVA} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link vdm.namespaces.enterpriseprojectcreatereadupdatedelete.link.EnterpriseProjectJVALink EnterpriseProjectJVALink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.s4hana.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class EnterpriseProjectJVAOneToOneLink<ObjectT extends VdmObject<?> >
    extends EnterpriseProjectJVALink<ObjectT>
    implements OneToOneLink<EnterpriseProjectJVA, ObjectT>
{
     ...
     */
    public EnterpriseProjectJVAOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<EnterpriseProjectJVA> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<EnterpriseProjectJVA>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
