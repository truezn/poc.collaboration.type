...
/**
 * Template class to represent entity navigation links of {@link vdm.namespaces.enterpriseprojectcreatereadupdatedelete.EnterpriseProject EnterpriseProject} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link vdm.namespaces.enterpriseprojectcreatereadupdatedelete.link.EnterpriseProjectLink EnterpriseProjectLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.s4hana.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class EnterpriseProjectOneToOneLink<ObjectT extends VdmObject<?> >
    extends EnterpriseProjectLink<ObjectT>
    implements OneToOneLink<EnterpriseProject, ObjectT>
{
     ...
     */
    public EnterpriseProjectOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<EnterpriseProject> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<EnterpriseProject>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
