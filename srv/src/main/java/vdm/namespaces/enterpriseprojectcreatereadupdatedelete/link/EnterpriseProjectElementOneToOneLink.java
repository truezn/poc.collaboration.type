...
/**
 * Template class to represent entity navigation links of {@link vdm.namespaces.enterpriseprojectcreatereadupdatedelete.EnterpriseProjectElement EnterpriseProjectElement} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link vdm.namespaces.enterpriseprojectcreatereadupdatedelete.link.EnterpriseProjectElementLink EnterpriseProjectElementLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.s4hana.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class EnterpriseProjectElementOneToOneLink<ObjectT extends VdmObject<?> >
    extends EnterpriseProjectElementLink<ObjectT>
    implements OneToOneLink<EnterpriseProjectElement, ObjectT>
{
     ...
     */
    public EnterpriseProjectElementOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<EnterpriseProjectElement> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<EnterpriseProjectElement>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
